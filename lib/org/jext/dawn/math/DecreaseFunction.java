/*
 * DecreaseFunction.java - -- operator
 ...
 * as published by the Free Software Foundation; either Decrease 2
 * of the License, or any later Decrease.
 *
...
/**
 * Decreases a numeric value (which can be in a variable) by one.<br>
 * Usage:<br>
 * <code>number --</code> or <code>var --</code>.
 * @author Romain Guy
 */

public class DecreaseFunction extends Function
{
