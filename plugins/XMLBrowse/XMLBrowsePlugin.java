/*
 * XMLBrowsePlugin.java - Python Plugin
...
public class XMLBrowsePlugin implements Plugin
{
  public void createMenuItems(JextFrame parent, Vector menus, Vector menuItems)
  {
    parent.getJextMenuBar().addMenu(GUIUtilities.loadMenu("XML_menu"), "Edit");
  }
