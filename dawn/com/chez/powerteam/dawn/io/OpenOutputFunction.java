/*
 * OpenOutputFunction.java - opens a file
...
package com.chez.powerteam.dawn.io;

import com.chez.powerteam.dawn.*;

/**
 * Opens a file from the HD to write in it. The opened file is designed by an ID.<br>
 * Usage:<br>
 * <code>file ID openForOutput</code><br>
...
public class OpenOutputFunction extends Function
{
  ...
  public void invoke(DawnParser parser) throws DawnRuntimeException
  {
    ...
    FileManager.openFileForOutput(parser.popString(), parser.popString(), this, parser);
  }
}
